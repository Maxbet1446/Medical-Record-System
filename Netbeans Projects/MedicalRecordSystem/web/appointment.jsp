...
<form name="appointmentForm" method="post" action="appointment_jsp.jsp">
    <div class="image2">
    	<div class="row">
    <div class="col-md-6">
...
<select id="appointmentfor" name="doctorName" type="text" class="form-control">
<option value="1">Dr.Jason</option>
